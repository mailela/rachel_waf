  ...
  <div class="login-container">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="off" label-position="left">
      <div class="title-container">
        <img  src="@/assets/img/logo.svg" class="el-image" />
      ...
      <el-button :loading="loading" type="primary" style="width:100%;margin-bottom:30px;" @click.native.prevent="handleLogin">初始化系统</el-button>

      <div class="tips">
        <span> 请输入帐号和密码初始化系统</span>
      </div>
  ...
  methods: {
    ...
    handleLogin() {
      this.$refs.loginForm.validate(valid => {
        if (valid) {
          this.loading = true
          this.$store.dispatch('user/init', this.loginForm).then((res) => {
